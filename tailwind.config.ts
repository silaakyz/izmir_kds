  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        luxcivic: {
          teal: "hsl(var(--luxcivic-teal))",
          "teal-light": "hsl(var(--luxcivic-teal-light))",
          cyan: "hsl(var(--luxcivic-cyan))",
        },
        score: {
      ...
      boxShadow: {
        glow: "0 0 40px hsl(var(--luxcivic-teal-light) / 0.3)",
        "glow-sm": "0 0 20px hsl(var(--luxcivic-teal-light) / 0.2)",
